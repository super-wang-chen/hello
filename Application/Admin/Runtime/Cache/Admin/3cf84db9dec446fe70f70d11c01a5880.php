      ...
      <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab2">
          <form action="" enctype="multipart/form-data" method="post">
            ...
            <p>
              <label>权限名称</label>
              <input class="text-input small-input" type="text" id="name" name="name" value="<?php echo ($info["name"]); ?>"/>
            ...
            <p>
              ...
              <?php if(in_array($vo['id'],$info['level_id']) == true): ?><input type="checkbox" checked="checked" class="box_1" name="level_id[]" value="<?php echo ($vo["id"]); ?>"/>
               	<b><?php echo ($vo["name"]); ?></b><br/>
              <?php else: ?>
               	<input type="checkbox"  class="box_1" name="level_id[]" value="<?php echo ($vo["id"]); ?>"/>
               	<b><?php echo ($vo["name"]); ?></b><br/><?php endif; ?> 	               	 
               	<?php if(is_array($vo['child_menu'])): foreach($vo['child_menu'] as $key=>$v): if(in_array($v['id'],$info['level_id']) == true): ?><input type="checkbox" checked="checked" class="box_2" name="level_id[]" value="<?php echo ($v["id"]); ?>"/>
            	  <span><?php echo ($v["name"]); ?></span>
            	<?php else: ?>
            	  <input type="checkbox" class="box_2" name="level_id[]" value="<?php echo ($v["id"]); ?>"/>
            	  <span><?php echo ($v["name"]); ?></span><?php endif; endforeach; endif; ?>
              <br/>
