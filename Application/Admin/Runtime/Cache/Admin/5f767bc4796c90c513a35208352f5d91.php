...
<script type="text/javascript" src="/tp/Application/Admin/Admin/Common/resources/scripts/login.js"></script>
...
<div id="login-wrapper" class="png_bg">
  <div id="login-top">
    <h1>Simpla Admin</h1>
    <!-- Logo (221px width) -->
    <a href="http://www.865171.cn"><img id="logo" src="/tp/Application/Admin/Admin/Common/resources/images/logo.png" alt="Simpla Admin logo" /></a></div>
  <!-- End #logn-top -->
  <div id="login-content">
    <form action="" id="loginForm" rel="/tp/admin.php/Index/check" method="post">
      ...
      <p>        
        ...
        <img src="/tp/admin.php/Index/VerifyCode" style="float:left;" id="codeA"/>   
      </p>
      <div class="clear"></div>
